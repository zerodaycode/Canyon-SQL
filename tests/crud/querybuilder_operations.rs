...
fn test_generated_sql_by_the_select_querybuilder() {
    ...
    let select_with_joins = League::select_query()
        ...
        .inner_join(
            ...
            LeagueField::id, // TODO: we need to change the output of the autogenerated enums (the field values entities)
            // to output directly ColumnRef, so we can build the relation with the table and field, instead of having to do the mapping manually here
