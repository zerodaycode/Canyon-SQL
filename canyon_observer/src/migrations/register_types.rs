...
impl CanyonRegisterEntityField {
    ...
    pub fn to_postgres_syntax(&self) -> String {
        ...
        match rust_type_clean.as_str() {
            rust_type::I8 | rust_type::U8 => String::from(&format!("{} NOT NULL", postgresql_type::INTEGER)),
            rust_type::OPT_I8 | rust_type::OPT_U8 => String::from(postgresql_type::INTEGER),

            rust_type::I16 | rust_type::U16 => String::from(&format!("{} NOT NULL", postgresql_type::INTEGER)),
            rust_type::OPT_I16 | rust_type::OPT_U16 => String::from(postgresql_type::INTEGER),
            
            rust_type::I32 | rust_type::U32 => String::from(&format!("{} NOT NULL", postgresql_type::INTEGER)),
            rust_type::OPT_I32 | rust_type::OPT_U32 => String::from(postgresql_type::INTEGER),
            
            rust_type::I64 | rust_type::U64 => String::from(&format!("{} NOT NULL", postgresql_type::BIGINT)),
            ...
            rust_type::NAIVE_DATE_TIME => String::from(&format!("{} NOT NULL", postgresql_type::DATETIME)),
    ...
    pub fn to_sqlserver_syntax(&self) -> String {
        ...
        match rust_type_clean.as_str() {
            ...
            rust_type::I16 | rust_type::U16 => String::from(&format!("{} NOT NULL", sqlserver_type::INT)),
            rust_type::OPT_I16 | rust_type::OPT_U16 => String::from(sqlserver_type::INT),
            
            rust_type::I32 | rust_type::U32 => String::from(&format!("{} NOT NULL", sqlserver_type::INT)),
            rust_type::OPT_I32 | rust_type::OPT_U32 => String::from(sqlserver_type::INT),
            
            rust_type::I64 | rust_type::U64 => String::from(&format!("{} NOT NULL", sqlserver_type::BIGINT)),
            rust_type::OPT_I64 | rust_type::OPT_U64 => String::from(sqlserver_type::BIGINT),
            
            rust_type::STRING => String::from(&format!("{} NOT NULL DEFAULT ''", sqlserver_type::NVARCHAR)),
            ...
            rust_type::NAIVE_DATE_TIME => String::from(&format!("{} NOT NULL", sqlserver_type::DATETIME)),
    ...
    pub fn to_postgres_alter_syntax(&self) -> String {
        ...
        match rust_type_clean.as_str() {
            ...
            rust_type::NAIVE_DATE_TIME | rust_type::OPT_NAIVE_DATE_TIME  => String::from(postgresql_type::DATETIME),
            &_ => todo!("Not supported datatype for this migrations version"),
        }
    }
    ...
    pub fn to_sqlserver_alter_syntax(&self) -> String {
        ...
        match rust_type_clean.as_str() {
            ...
            rust_type::NAIVE_DATE_TIME | rust_type::OPT_NAIVE_DATE_TIME  => String::from(sqlserver_type::DATETIME),
            &_ => todo!("Not supported datatype for this migrations version"),
        }
    }
