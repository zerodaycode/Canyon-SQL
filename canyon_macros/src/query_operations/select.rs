...
pub fn generate_read_operations_tokens(
    ...
    let find_all_datasource = create_find_all_with_macro(ty, &fa_stmt);
...
mod __details {
    ...
    pub mod find_all_generators {
        ...
        pub fn create_find_all_unchecked_ds_macro(
            ty: &syn::Ident,
            stmt: &str,
        ) -> MacroOperationBuilder {
            MacroOperationBuilder::new()
    ...
    pub mod pk_generators {
        ...
        pub fn create_find_by_pk_datasource(
            ty: &Ident,
            stmt: &str,
            result_handling: &TokenStream,
        ) -> MacroOperationBuilder {
...
mod macro_builder_read_ops_tests {
    ...
    fn test_macro_builder_find_all_unchecked_datasource() {
        ...
        let find_all_unc_ds = find_all_unc_ds_builder.generate_tokens().to_string();
    ...
    fn test_macro_builder_count_datasource() {
        ...
        let count_ds = count_ds_builder.generate_tokens().to_string();
    ...
    fn test_macro_builder_find_by_pk_datasource() {
        ...
        let find_by_pk_ds = find_by_pk_ds_builder.generate_tokens().to_string();
