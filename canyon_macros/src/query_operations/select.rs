        ...
        for field in &entity.entity_fields {
            ...
            for annotation in &field.annotations {
                if annotation.starts_with("Annotation: ForeignKey") {
                    ...
                    println!("[MACRO DEBUG] - method_name: {:?}", &quoted_method_name.to_token_stream().to_string());
                    ...
                    println!("[MACRO DEBUG] - fk_type: {:?}", &fk_ty.to_string());
                    ...
                    println!("[MACRO DEBUG] - field: {:?}", &field);
                    println!("[MACRO DEBUG] - field_name: {:?}", &field.field_name);
                    println!("[MACRO DEBUG] - field_ident: {:?}", &field_ident);

                    let field_value = quote! { &self.#field_ident };
                    println!("[MACRO DEBUG] - field_value: {:?}", &field_value.to_token_stream().to_string());
