...
fn generate_function(
    ...
    let lt = if with_lifetime { quote!{ <'a> } } else { quote!{} };
    let with_unwrap = if with_unwrap { quote!{ .unwrap() } } else { quote!{} };

    quote! {
        #[doc = #base_doc_comment]
        #[doc = #doc_comment]
        async fn #fn_name #lt(#datasource_param) -> Vec<#ty> {
