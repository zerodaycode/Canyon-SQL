...
pub fn generate_read_operations_tokens(
    ...
    let find_all_tokens =
        generate_find_all_operations_tokens(mapper_ty, table_schema_data);
    let count_tokens = generate_count_operations_tokens(table_schema_data);
    let find_by_pk_tokens =
        generate_find_by_pk_operations_tokens(macro_data, table_schema_data);
...
fn generate_find_all_operations_tokens(
    ...
    let find_all =
        __details::find_all_generators::create_find_all_macro(mapper_ty, &fa_stmt);
    let find_all_with =
...
mod macro_builder_read_ops_tests {
    ...
    fn test_create_find_by_pk_macro() {
        ...
        let tokens =
            create_find_by_pk_macro(&mapper_ty, FIND_BY_PK_STMT, &pk_runtime_error);
        let generated = tokens.to_string();
