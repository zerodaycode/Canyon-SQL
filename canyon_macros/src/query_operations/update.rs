...
fn generate_update_query_tokens(
    ty: &Ident,
...
mod update_tokens_tests {
    use crate::query_operations::consts::{INPUT_PARAM, LT_CONSTRAINT, RES_VOID_RET_TY, RES_VOID_RET_TY_LT, USER_MOCK_TY, VOID_RET_TY};
    use crate::query_operations::update::__details::{create_update_err_macro, create_update_err_with_macro};
