    ...
    Vec<R>: FromIterator<<R as RowMapper>::Output>,
{
    ...
    /// Generates a [`SelectQueryBuilder`] that allows you to customize the query by adding parameters
    /// and constrains dynamically.
    ///
    ...
    where
        T: RowMapper + EntityRuntimeInfo + Sync + 'a;
