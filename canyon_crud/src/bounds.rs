...
#[cfg(feature = "postgres")] impl Row for tokio_postgres::Row {
    fn as_any(&self) -> &dyn Any {
        self
    }
}
#[cfg(feature = "mssql")] impl Row for tiberius::Row {
    fn as_any(&self) -> &dyn Any {
        self
    }
}
...
#[cfg(feature = "postgres")] impl Type for tokio_postgres::types::Type {
    fn as_any(&self) -> &dyn Any {
        self
    }
}
...
pub enum ColumnType {
    #[cfg(feature = "postgres")] Postgres(tokio_postgres::types::Type),
    #[cfg(feature = "mssql")] SqlServer(tiberius::ColumnType),
}
...
pub trait QueryParameter<'a>: std::fmt::Debug + Sync + Send {
    #[cfg(feature = "postgres")] fn as_postgres_param(&self) -> &(dyn ToSql + Sync);
    #[cfg(feature = "mssql")] fn as_sqlserver_param(&self) -> ColumnData<'_>;
}
...
impl<'a> QueryParameter<'a> for &f64 {
    ...
    #[cfg(feature = "mssql")] #[cfg(feature = "mssql")] fn as_sqlserver_param(&self) -> ColumnData<'_> {
        ColumnData::F64(Some(**self))
    }
}
